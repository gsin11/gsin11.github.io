...
<picture>
  <source srcset="/assets/img/i-dont-know-javascript-but-reactjs-800w.webp" media="(min-width: 1000px)">
  <source srcset="/assets/img/i-dont-know-javascript-but-reactjs-640w.webp" media="(min-width: 800px)">
  <img srcset="/assets/img/i-dont-know-javascript-but-reactjs-320w.webp" alt="I don't know JavaScript but ReactJS" loading="lazy">
</picture>
...
I would suggest directly starting with ES6 (ECMAScript) since the latest browsers support it and you can use a transcompiler like <a href="https://babeljs.io/">Babel</a> if you need to support legacy browsers.
...
<a href="https://github.com/gsin11/up-and-running-with-es6">up-and-running-with-es6</a>
